...
export const metadata = {
  title: "Men's Skiing | Match Moments",
  description: "Complete coverage of men's skiing - World Cup & Olympics",
};
...
async function getPageData() {
  try {
    ...
    const [competitionsRes, matchesRes, momentsRes] = await Promise.all([
      fetch(`${baseUrl}/api/sports/competitions?sport=Skiing&gender=Men's Team&limit=10`, {
        cache: 'no-store',
      }),
      fetch(`${baseUrl}/api/sports/matches?sport=Skiing&gender=Men's Team&limit=10`, {
        cache: 'no-store',
      }),
      fetch(`${baseUrl}/api/sports/moments/trending?sport=Skiing&gender=Men's Team&limit=10`, {
        cache: 'no-store',
      }),
    ]);
...
export default async function MensSkiingPage() {
      ...
      <div className="container-main py-8">
        <BreadcrumbNav
          items={[
            ...
            { label: 'Skiing', href: '/mens/skiing', current: true },
          ]}
        />
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-700 to-blue-900 p-12 text-white">
            <div className="relative z-10">
              ...
              <p className="text-xl opacity-90 mb-6">
                Men's World Cup, Olympics & major skiing events
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center py-16 bg-white rounded-3xl border border-gray-200">
          ...
          <p className="text-gray-600 max-w-md mx-auto">
            Men's skiing coverage is coming soon to Match Moments.
          </p>
        </div>
      </div>
    </main>
