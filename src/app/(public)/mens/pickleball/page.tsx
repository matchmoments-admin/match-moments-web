...
export const metadata = {
  title: "Men's Pickleball | Match Moments",
  description: "Complete coverage of men's pickleball",
};
...
async function getPageData() {
  try {
    ...
    const [competitionsRes, matchesRes, momentsRes] = await Promise.all([
      fetch(`${baseUrl}/api/sports/competitions?sport=Pickleball&gender=Men's Team&limit=10`, {
        cache: 'no-store',
      }),
      fetch(`${baseUrl}/api/sports/matches?sport=Pickleball&gender=Men's Team&limit=10`, {
        cache: 'no-store',
      }),
      fetch(`${baseUrl}/api/sports/moments/trending?sport=Pickleball&gender=Men's Team&limit=10`, {
        cache: 'no-store',
      }),
    ]);
...
export default async function MensPickleballPage() {
      ...
      <div className="container-main py-8">
        <BreadcrumbNav
          items={[
            ...
            { label: 'Pickleball', href: '/mens/pickleball', current: true },
          ]}
        />
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-pink-600 to-pink-800 p-12 text-white">
            <div className="relative z-10">
              ...
              <p className="text-xl opacity-90 mb-6">
                Professional men's pickleball tours and competitions
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center py-16 bg-white rounded-3xl border border-gray-200">
          ...
          <p className="text-gray-600 max-w-md mx-auto">
            Men's pickleball coverage is coming soon to Match Moments.
          </p>
        </div>
      </div>
    </main>
